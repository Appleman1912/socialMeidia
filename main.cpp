...
//Here we know that user exists so we do not jave to check in functions ReturnIndexOfUser AND RemoveFromGraph AND ReturnUser AND CheckIfTwoUsersAreBanned  if he exists again!!!
